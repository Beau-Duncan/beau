...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://tdmpxshvlolwrggpqauy.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_RUx_GAYDufZUmtEfZ1rZGw_Ma_ECs3N';
...
.topbar {
  ...
  padding: max(28px, env(safe-area-inset-top)) max(14px, env(safe-area-inset-right)) 10px max(14px, env(safe-area-inset-left));
